...
const PREGNANCY_FRUITS: { emoji: string; label: string; sizeCm: number }[] = [
  /* SA 0    */ { emoji: '🌱', label: 'petite graine', sizeCm: 0 },
  /* SA 1    */ { emoji: '🌱', label: 'petite graine', sizeCm: 0 },
  /* SA 2    */ { emoji: '🌱', label: 'petite graine', sizeCm: 0 },
  /* SA 3    */ { emoji: '🌱', label: 'petite graine', sizeCm: 0 },
  /* SA 4    */ { emoji: '🌱', label: 'petite graine', sizeCm: 0.1 },
  /* SA 5    */ { emoji: '🍚', label: 'grain de riz', sizeCm: 0.2 },
  /* SA 6    */ { emoji: '🫐', label: 'myrtille', sizeCm: 0.4 },
  /* SA 7    */ { emoji: '🫐', label: 'grosse myrtille', sizeCm: 1 },
  ...
  /* SA 15   */ { emoji: '🍊', label: 'orange', sizeCm: 17 },
  ...
  /* SA 28   */ { emoji: '🍠', label: 'patate douce', sizeCm: 37.5 },
  /* SA 29   */ { emoji: '🎃', label: 'courge', sizeCm: 39 },
  /* SA 30   */ { emoji: '🥬', label: 'chou', sizeCm: 40 },
  /* SA 31   */ { emoji: '🥥', label: 'grosse noix de coco', sizeCm: 41 },
  /* SA 32   */ { emoji: '🍍', label: 'ananas', sizeCm: 42.5 },
  /* SA 33   */ { emoji: '🥒', label: 'courgette', sizeCm: 43.5 },
  /* SA 34   */ { emoji: '🎃', label: 'courge butternut', sizeCm: 45 },
  /* SA 35   */ { emoji: '🍈', label: 'melon', sizeCm: 46 },
  /* SA 36   */ { emoji: '🥬', label: 'chou frisé', sizeCm: 47 },
  /* SA 37   */ { emoji: '🍐', label: 'grosse poire', sizeCm: 48 },
