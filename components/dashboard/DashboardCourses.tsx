...
function DashboardCoursesInner(_props: DashboardSectionProps) {
  ...
  return (
    <DashboardCard key="courses" title={t('dashboard.courses.title')} icon="🛒" color={colors.catOrganisation} tinted onPressMore={() => router.push({ pathname: '/(tabs)/meals', params: { tab: 'courses' } })} hideMoreLink style={{ flex: 1, marginBottom: 0 }}>
