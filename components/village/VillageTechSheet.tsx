...
function AwningStripes({ farm, styles }: { farm: FarmPalette; styles: ReturnType<typeof makeStyles> }) {
  return (
...
// Précalcul des deux variantes de StyleSheet (1× au chargement du module)
