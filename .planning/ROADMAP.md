...
Plans:
- [ ] 46-01-PLAN.md — Helper lib/auberge/auto-tick.ts + 3 fonctions notifs Auberge + entrée BUILTIN_NOTIFICATIONS + tests Jest
...
- [ ] 46-04-PLAN.md — Re-gate __DEV__ autour du bouton 'Forcer un visiteur' dans AubergeSheet.tsx
