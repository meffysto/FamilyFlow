...
- [x] **LOVE-13**: User voit une animation "unfold" Reanimated (rotation X du rabat ≥175°, cachet qui saute, contenu dévoilé) au tap sur une enveloppe `revealed`, accompagnée d'un haptic `notificationAsync('success')` — la note passe ensuite en `read`
...
| LOVE-13 | Phase 36 — Composition & programmation reveal | Complete |
