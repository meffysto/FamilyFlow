# Requirements Archive: v1.1 Ferme Enrichie
...
- [~] **COMP-07** (abandonné): Le compagnon sert d'avatar de profil dans la tab bar et le selecteur de profil
...
- [x] **QUEST-01**: Une quete familiale peut etre demarree, progressee par n'importe quel membre de la famille, et completee avec une recompense ferme distribuee a tous
- [x] **QUEST-02**: La ferme affiche un widget banniere montrant la quete active, la progression globale famille, et les contributions par membre
- [x] **QUEST-03**: Les recompenses de quete sont des effets ferme distinctifs (cultures accelerees, cultures dorees garanties, batiments offerts, graines rares, trophee familial permanent) — distinctes des XP individuels
