 ...
 *
 * NOTE: loadGamiConfig / saveGamiConfig (expo-secure-store) removed for shared
 * package. Use getCachedGamiConfig() or pass config explicitly.
 */
...
/** Injecte la config depuis l'extérieur (ex: SecureStore côté app) */
export function setCachedGamiConfig(config: GamificationConfig): void {
