...
export interface Profile {
  ...
  treeSpecies?: import('./mascot/types').TreeSpecies; // espèce d'arbre mascotte
  ...
  farmBuildings?: import('./mascot/types').PlacedBuilding[];  // Batiments places sur la grille
  farmInventory?: import('./mascot/types').FarmInventory;     // Inventaire ressources (oeuf, lait, farine)
  harvestInventory?: import('./mascot/types').HarvestInventory;  // Recoltes brutes en stock
  craftedItems?: import('./mascot/types').CraftedItem[];         // Items craftes en inventaire
  farmTech?: string[];    // IDs des noeuds tech debloques
  farmRareSeeds?: import('./mascot/types').RareSeedInventory;  // Graines rares en stock
