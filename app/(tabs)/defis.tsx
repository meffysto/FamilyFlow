...
const configStyles = StyleSheet.create({
  ...
  emojiText: { fontSize: FontSize.icon },
  input: {
  ...
  profileAvatar: { fontSize: FontSize.heading },
...
const detailStyles = StyleSheet.create({
  ...
  participantAvatar: { fontSize: FontSize.display },
  ...
  checkInBtnAvatar: { fontSize: FontSize.heading },
